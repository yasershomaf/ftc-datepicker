	...
	constructor(props) {
		...
		if (props.propsConsoleLog) {
			const consoleObj = {
				...
				showDatePickerDetails: this.showDatePickerDetails,
	...
	render() {
		...
		return <div className={this.containerClassName}>
			...
			{this.state.isVisible ? <div className={classNames.DATE_PICKER} onClick={this.datePickerClickHandler}>
				...
				{this.showDatePickerDetails ? <div className={classNames.DATE_PICKER_DETAILS}>{selectedDates}</div> : null}
...
DatePicker.propTypes = {
	...
	showDatePickerDetails: PropTypes.bool,
